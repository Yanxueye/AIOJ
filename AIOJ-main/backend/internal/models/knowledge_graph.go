...
type UserKnowledgeGraph struct {
	...
	UserID    uint64    `gorm:"uniqueIndex:idx_user_scope;not null" json:"userId"`
	Scope     string    `gorm:"type:varchar(32);default:'recent';uniqueIndex:idx_user_scope" json:"scope"`
