...
const routes = [
  ...
  { path: '/my/solutions', name: 'my-solutions', component: () => import('@/views/MySolutions.vue'), meta: { title: '我的题解 - TerminalOJ', auth: true } },
  ...
  { path: '/solutions/:id', name: 'solution-detail', component: () => import('@/views/SolutionDetail.vue'), meta: { title: '题解详情 - TerminalOJ', auth: true } },
...
router.beforeEach((to, from, next) => {
  ...
  } else if (to.meta.admin && !userStore.canManageProblems) {
    next({ name: 'home' })
