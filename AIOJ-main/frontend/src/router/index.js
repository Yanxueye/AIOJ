...
const routes = [
  ...
  { path: '/study-plans', name: 'study-plans', component: () => import('@/views/StudyPlans.vue'), meta: { title: '学习计划 - TerminalOJ' } },
  ...
  { path: '/ai', name: 'ai-chat', component: () => import('@/views/AITraining.vue'), meta: { title: 'AI 对话 - TerminalOJ', auth: true } },
